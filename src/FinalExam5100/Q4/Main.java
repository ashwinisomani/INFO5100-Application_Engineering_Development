...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        Movie a = new Movie("Titanic", new GregorianCalendar(2008, Calendar.FEBRUARY, 15).getTime(),
                Arrays.asList("AB", "ABC"), "Director1");
        Movie b = new Movie("CaptainAmerica", new GregorianCalendar(1998, Calendar.AUGUST, 03).getTime(),
                Arrays.asList("XCD", "ADB", "ABB"), "Director3");
        Movie c = new Movie("SpiderMan", new GregorianCalendar(2020, Calendar.DECEMBER, 01).getTime(),
                Arrays.asList("CCC", "RAB"), "Director2");
        Movie d = new Movie("Hulk", new GregorianCalendar(1997, Calendar.JUNE, 24).getTime(),
                Arrays.asList("NUC", "ACC"), "Director4");
